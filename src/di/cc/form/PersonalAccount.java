...
public class PersonalAccount extends PersonalAccountGUI {
	...
	protected void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
		...
		Person customer = injector.getInstance(Person.class);
	...
	public String[] getColumns() {
		...
		return new String[] { "Accout No.", "Customer Name", "City", "Zip", "Customer Type", "Account Type","Balance"};
	}
